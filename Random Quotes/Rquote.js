let myQuotes = {"- Walt Disney": '"The Way Get Started Is To Quit Talking And Begin Doing."',
...
"- Mahatma Gandhi": '"You can chain me, you can torture me even you can destroy my body, but You’ll never imprison my mind"',
...
var Qtext = document.getElementById('quotebox');
var Qauth = document.getElementById('quoteauthor');

let authors = Object.keys(myQuotes);

function myFunction(){
        var author = authors[Math.floor(Math.random() * authors.length)];
        Qtext.textContent = myQuotes[author];
        Qauth.textContent = author;
}